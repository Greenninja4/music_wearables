...
// OSC
char device[] = "/device2";              // Device name sent through OSC
...
int buttonPrev0 = 0;
int buttonCurr0 = 0;
const int button1 = 13;                   // Button 2 connects to esp-thing:GPIO 14, Wrover: 13
int buttonPrev1 = 0;
int buttonCurr1 = 0;
const int button2 = 14;                   // Button 3 connects to esp-thing:GPIO 15, Wrover: 14
int buttonPrev2 = 0;
int buttonCurr2 = 0;
const int button3 = 15;                   // Button 4 connects to esp-thing:GPIO 13, Wrover: 15
int buttonPrev3 = 0;
int buttonCurr3 = 0;
...
const int ledPinR = 25;                   // Red LED connects to esp-thing:GPIO 16, Wrover: 25
const int ledPinG = 26;                   // Green LED connects to esp-thing:GPIO 17, Wrover: 26
const int ledPinB = 27;                   // Blue LED connects to esp-thing:GPIO 18, Wrover: 27
